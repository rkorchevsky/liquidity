...
public class UserDataUpdateEventDeserializer extends JsonDeserializer<UserDataUpdateEvent> {
    ...
    public UserDataUpdateEvent deserialize(JsonParser jp, DeserializationContext ctx) throws IOException {
        ...
        if (userDataUpdateEventType == UserDataUpdateEvent.UserDataUpdateEventType.ACCOUNT_UPDATE) {
            var accountUpdateEvent = getUserDataUpdateEventDetail(json, AccountUpdateEvent.class, mapper);
            ...
            var orderTradeUpdateEvent = getUserDataUpdateEventDetail(json, OrderTradeUpdateEvent.class, mapper);
